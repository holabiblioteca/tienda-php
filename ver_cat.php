...
$categoria_seleccionada = $_POST["accion"];
$categoria = (isset($_POST['accion'])) ? $_POST['accion'] : "";

$sentencia = $pdo->prepare("SELECT * FROM tblproductos WHERE categoria='$categoria' and stock=1 order by ID ASC");
$sentencia->execute();
...
<div class="container">
    <div class="row">
        <div class="p-1 bg-primary text-white rounded text-center">
            <h4><?php echo $categoria_seleccionada; ?></h4>
        </div>
    </div>
